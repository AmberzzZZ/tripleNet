...
if __name__ == '__main__':
    ...
    model.load_weights('unlinear_model_02_val_acc_0.991.h5', by_name=True)
    ...
    func = K.function(inputs=[], outputs=[model.get_layer('embedding_1').output])
    ...
    for i, each_cls in enumerate(cate):
        ...
        threshold = intra_distances[int(y_train.shape[0]*0.8)]
